            ...
            <div className="mt-30">
              ...
              <div className="mt-15">
                <div className="bg-gray-200 p-2.5 rounded-10 text-[12px] leading-5 text-gray-600">
                  ...
                  <br /> If you are listing multiple advertising opportunities
                  of the same description as this listing, type the amount below
                  so that we can calculate the correct fee.
                </div>
              </div>
              <div className="mt-15">
                <Input
